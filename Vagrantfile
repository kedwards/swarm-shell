    ...
    if machine['enabled'] == true
      ...
      config.vm.define machine['name'] do |srv|
        ...
        config.trigger.after :up do |trigger|
          ...
          trigger.run = { inline: "docker-machine create -d generic --generic-ip-address " + machine['ip_addr'] + " --generic-ssh-port 22 --generic-ssh-key /home/kedwards/.ssh/id_rsa --generic-ssh-user vagrant " + machine['name'] }
        end
